// papa ko pages me dalo and unke childs ko components me dalne chahiye
// i.e nested routes ko components me dalna chahiye
import React, { useState } from 'react';
import { Plus, Edit, Trash2, Home, RefreshCw, Zap } from 'lucide-react';
// lucide-react is library for icon
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {adminOptions.map((option) => {
            ...
            return (
              <div
                key={option.id}
                className="card card1 bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer"
              >
