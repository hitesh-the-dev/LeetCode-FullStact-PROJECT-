...
function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-base-200"> {/* Added bg for contrast */}
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-control"> {/* Removed mt-4 from first form-control for tighter spacing to title or global error */}
              ...
              <input
                ...
                className={`input input-bordered rounded-xl w-full ${errors.emailId ? 'input-error' : ''}`}
                {...register('emailId')}
              />
              {errors.emailId && (
