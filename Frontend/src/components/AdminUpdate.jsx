...
function AdminUpdate() {
    ...
    const fetchProblem = async () => {
      try {
        ...
        reset({
          ...
          difficulty: Array.isArray(problem.difficulty) ? problem.difficulty[0] : problem.difficulty,
          tags: Array.isArray(problem.tags) ? problem.tags[0] : problem.tags,
          visibleTestCases: problem.visibleTestCases || [],
          hiddenTestCases: problem.hiddenTestCases || [],
          startCode: problem.startCode ? problem.startCode.map(item => ({
          ...
          referenceSolution: problem.referenceSolution ? problem.referenceSolution.map(item => ({
            language: item.language.charAt(0).toUpperCase() + item.language.slice(1),
  ...
  const onSubmit = async (data) => {
    try {
      console.log('Updating problem data:', data);
      
      // Convert language names to lowercase for backend compatibility
      // Convert single values to arrays for difficulty and tags
      const processedData = {
        ...data,
        difficulty: [data.difficulty], // Convert to array
        tags: [data.tags], // Convert to array
      ...
      const response = await axiosClient.put(`/problem/update/${id}`, processedData);
        ...
        <div className="card bg-base-100 shadow-lg p-6">
          ...
          <div className="space-y-4">
            <div className="form-control">
              <label className="label p-12 font-medium">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium p-6">Description</span>
              </label>
              <textarea
            ...
            <div className="flex gap-4">
              <div className="form-control w-1/2">
                <label className="label">
                  <span className="label-text font-medium p-8">Difficulty</span>
                </label>
                <select
                  {...register('difficulty')}
              ...
              <div className="form-control w-1/2">
                <label className="label">
                  <span className="label-text mt-6 p-3">Tag</span>
                </label>
                <select
                  {...register('tags')}
